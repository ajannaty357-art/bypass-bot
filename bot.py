...
def bypass_link(message):
    url = message.text
    if "http" in url:
        waiting_msg = bot.reply_to(message, "⏳ বাইপাস করা হচ্ছে, দয়া করে একটু অপেক্ষা করুন...")
        try:
            ...
            if response.status_code == 200:
                ...
                bot.edit_message_text(f"✅ **সফলভাবে বাইপাস হয়েছে!**\n\n🔗 **আসল লিংক:** {bypassed_url}", 
            ...
            bot.edit_message_text(f"⚠️ সমস্যা হয়েছে: {str(e)}", 
                                  chat_id=message.chat.id, message_id=waiting_msg.message_id)
    else:
        bot.reply_to(message, "⚠️ দয়া করে একটি সঠিক লিংক (http/https সহ) পাঠান!")
